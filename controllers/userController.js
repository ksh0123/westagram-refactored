...
const signUp = catchAsync(async (req, res) => {
  const { email, password, nickname, firstName, lastName, profileImage } = req.body
  ...
  await userService.signUp(email, password, nickname, firstName, lastName, profileImage)
